...
import { FileText, Share2, Activity, ShieldCheck, Users, Settings } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: "Settings", href: "/dashboard/settings",  icon: Settings,  label: "Account Settings" },
];
